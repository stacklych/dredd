...
Before reporting a bug, please try to first [search existing GitHub issues](https://github.com/dalberola/dredd/issues?utf8=%E2%9C%93&q=is%3Aissue) to see whether your problem wasn't already discussed.

To report a bug, [open a new GitHub issue](https://github.com/dalberola/dredd/issues/new). To report privately, e.g. to alert the maintainers about a security problem, please open a private [security advisory](https://github.com/dalberola/dredd/security/advisories) on the repository.
...
- [Open a new GitHub issue](https://github.com/dalberola/dredd/issues/new)
...
The documentation is written [as code](http://www.writethedocs.org/guide/docs-as-code/) in the [reStructuredText](http://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html) format and its source files are located in the [docs](https://github.com/dalberola/dredd/tree/master/docs) directory. It is published automatically by the [ReadTheDocs](https://readthedocs.org/) when the `master` branch is updated.

If you want to propose improvements to the documentation, you don't need to install the whole project. Usually it is just fine to use the [GitHub's editing features](https://github.com/dalberola/dredd/edit/master/docs/installation.rst).
...
- Look at [easy to fix issues](https://github.com/dalberola/dredd/labels/easy%20to%20fix)
